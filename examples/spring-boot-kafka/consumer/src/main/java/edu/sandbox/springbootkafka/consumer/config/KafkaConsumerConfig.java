...
import edu.sandbox.springbootkafka.consumer.serializer.DltMessageSerializer;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, Message> consumerFactory(KafkaProperties kafkaProperties, ObjectMapper mapper) {
        ...
        properties.put(JsonDeserializer.TYPE_MAPPINGS, "edu.sandbox.springbootkafkabasics.producer.model.Message:edu.sandbox.springbootkafkabasics.consumer.model.Message");
